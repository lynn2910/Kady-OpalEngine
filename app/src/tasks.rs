...
pub(crate) struct CacheMemoryReport {
    ...
    pub guilds: MemRep,
    pub users: MemRep,
    pub application: MemRep,
    pub client_user: MemRep,
    pub cache_total: f64
}

#[derive(Clone, Serialize, Deserialize, Default)]
pub struct MemRep((usize, f64));

impl From<(usize, f64)> for MemRep {
    fn from(v: (usize, f64)) -> Self {
        Self(v)
    }
}

impl Debug for MemRep {
