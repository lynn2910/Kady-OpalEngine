            ...
            None => {
                ...
                broadcast_error!(
                    localisation: BroadcastLocalisation::default()
                        ...
                        .set_code_path("app::scripts::button::captcha_request.rs:45"),
        ...
        None => {
            ...
            broadcast_error!(
                localisation: BroadcastLocalisation::default()
                    ...
                    .set_channel(payload.interaction.channel_id.clone())
                    .set_user(payload.interaction.user.clone())
                    .set_code_path("app::scripts::button::captcha_request.rs:75"),
                interaction: BroadcastInteraction::default()
                    .set_type(BroadcastInteractionType::Button)
                    .set_name("captcha_request"),
                details: BroadcastDetails::default()
            ...
            _ => {
                ...
                broadcast_error!(
                    localisation: BroadcastLocalisation::default()
                        ...
                        .set_channel(payload.interaction.channel_id.clone())
                        .set_user(payload.interaction.user.clone())
                        .set_code_path("app::scripts::button::captcha_request.rs:114"),
                    interaction: BroadcastInteraction::default()
                        .set_type(BroadcastInteractionType::Button)
                        .set_name("captcha_request"),
                    details: BroadcastDetails::default()
            ...
            Err(e) => {
                ...
                broadcast_error!(
                    localisation: BroadcastLocalisation::default()
                        ...
                        .set_channel(payload.interaction.channel_id.clone())
                        .set_user(payload.interaction.user.clone())
                        .set_code_path("app::scripts::button::captcha_request.rs:149"),
                    interaction: BroadcastInteraction::default()
                        .set_type(BroadcastInteractionType::Button)
                        .set_name("captcha_request"),
                    details: BroadcastDetails::default()
            ...
            Err(e) => {
                ...
                broadcast_error!(
                    localisation: BroadcastLocalisation::default()
                        ...
                        .set_channel(payload.interaction.channel_id.clone())
                        .set_user(payload.interaction.user.clone())
                        .set_code_path("app::scripts::button::captcha_request.rs:212"),
                    interaction: BroadcastInteraction::default()
                        .set_type(BroadcastInteractionType::Button)
                        .set_name("captcha_request"),
                    details: BroadcastDetails::default()
            ...
            _ => {
                ...
                broadcast_error!(
                    localisation: BroadcastLocalisation::default()
                        ...
                        .set_channel(payload.interaction.channel_id.clone())
                        .set_user(payload.interaction.user.clone())
                        .set_code_path("app::scripts::button::captcha_request.rs:275"),
                    interaction: BroadcastInteraction::default()
                        .set_type(BroadcastInteractionType::Button)
                        .set_name("captcha_request"),
                    details: BroadcastDetails::default()
        ...
        Err(e) => {
            ...
            broadcast_error!(
                localisation: BroadcastLocalisation::default()
                    ...
                    .set_channel(payload.interaction.channel_id.clone())
                    .set_user(payload.interaction.user.clone())
                    .set_code_path("app::scripts::button::captcha_request.rs:357"),
                interaction: BroadcastInteraction::default()
                    .set_type(BroadcastInteractionType::Button)
                    .set_name("captcha_request"),
                details: BroadcastDetails::default()
