                ...
                Err(e) => {
                    ...
                    broadcast_error!(
                        localisation: BroadcastLocalisation::default()
                            ...
                            .set_code_path("app/src/scripts/slashs/xp.rs:guild_rank:48"),
                ...
                Err(e) => {
                    broadcast_error!(
                        localisation: BroadcastLocalisation::default()
                            .set_guild(payload.interaction.guild_id.clone())
                            .set_channel(payload.interaction.channel_id.clone())
                            .set_code_path("app/src/scripts/slashs/xp.rs:guild_rank:131"),
                        interaction: BroadcastInteraction::default()
                            .set_name("guild_rank")
                            .set_type(BroadcastInteractionType::SlashCommand),
                        details: BroadcastDetails::default()
                            .add("reason", format!("Cannot acquire the guild member: {e:#?}")),
                        ctx.skynet.as_ref()
                    );
                ...
                Err(e) => {
                    ...
                    broadcast_error!(
                        localisation: BroadcastLocalisation::default()
                            .set_guild(payload.interaction.guild_id.clone())
                            .set_channel(payload.interaction.channel_id.clone())
                            .set_code_path("app/src/scripts/slashs/xp.rs:guild_rank:155"),
                        interaction: BroadcastInteraction::default()
                            .set_name("guild_rank")
                            .set_type(BroadcastInteractionType::SlashCommand),
                        details: BroadcastDetails::default()
            ...
            Err(e) => {
                ...
                broadcast_error!(
                    localisation: BroadcastLocalisation::default()
                        .set_guild(payload.interaction.guild_id.clone())
                        .set_channel(payload.interaction.channel_id.clone())
                        .set_code_path("app/src/scripts/slashs/xp.rs:guild_rank:174"),
                    interaction: BroadcastInteraction::default()
                        .set_name("guild_rank")
                        .set_type(BroadcastInteractionType::SlashCommand),
                    details: BroadcastDetails::default()
                ...
                Err(e) => {
                    ...
                    broadcast_error!(
                        localisation: BroadcastLocalisation::default()
                            .set_guild(payload.interaction.guild_id.clone())
                            .set_channel(payload.interaction.channel_id.clone())
                            .set_code_path("app/src/scripts/slashs/xp.rs:guild_rank:202"),
                        interaction: BroadcastInteraction::default()
                            .set_name("guild_rank")
                            .set_type(BroadcastInteractionType::SlashCommand),
                        details: BroadcastDetails::default()
                ...
                Err(e) => {
                    ...
                    broadcast_error!(
                        localisation: BroadcastLocalisation::default()
                            .set_guild(payload.interaction.guild_id.clone())
                            .set_channel(payload.interaction.channel_id.clone())
                            .set_code_path("app/src/scripts/slashs/xp.rs:guild_rank:229"),
                        interaction: BroadcastInteraction::default()
                            .set_name("guild_rank")
                            .set_type(BroadcastInteractionType::SlashCommand),
                        details: BroadcastDetails::default()
            ...
            Err(e) => {
                ...
                broadcast_error!(
                    localisation: BroadcastLocalisation::default()
                        .set_guild(payload.interaction.guild_id.clone())
                        .set_channel(payload.interaction.channel_id.clone())
                        .set_code_path("app/src/scripts/slashs/xp.rs:guild_rank:251"),
                    interaction: BroadcastInteraction::default()
                        .set_name("guild_rank")
                        .set_type(BroadcastInteractionType::SlashCommand),
                    details: BroadcastDetails::default()
            ...
            None => {
                ...
                broadcast_error!(
                    localisation: BroadcastLocalisation::default()
                        .set_guild(payload.interaction.guild_id.clone())
                        .set_channel(payload.interaction.channel_id.clone())
                        .set_code_path("app/src/scripts/slashs/xp.rs:guild_rank:275"),
                    interaction: BroadcastInteraction::default()
                        .set_name("guild_rank")
                        .set_type(BroadcastInteractionType::SlashCommand),
                    details: BroadcastDetails::default()
            ...
            Err(e) => {
                ...
                broadcast_error!(
                    localisation: BroadcastLocalisation::default()
                        .set_guild(payload.interaction.guild_id.clone())
                        .set_channel(payload.interaction.channel_id.clone())
                        .set_code_path("app/src/scripts/slashs/xp.rs:guild_rank:301"),
                    interaction: BroadcastInteraction::default()
                        .set_name("guild_rank")
                        .set_type(BroadcastInteractionType::SlashCommand),
                    details: BroadcastDetails::default()
                    ...
                    Ok(Err(e)) => {
                        ...
                        broadcast_error!(
                            localisation: BroadcastLocalisation::default()
                                .set_guild(payload.interaction.guild_id.clone())
                                .set_channel(payload.interaction.channel_id.clone())
                                .set_code_path("app/src/scripts/slashs/xp.rs:guild_rank:332"),
                            interaction: BroadcastInteraction::default()
                                .set_name("guild_rank")
                                .set_type(BroadcastInteractionType::SlashCommand),
                            details: BroadcastDetails::default()
                    ...
                    Err(e) => {
                        ...
                        broadcast_error!(
                            localisation: BroadcastLocalisation::default()
                                .set_guild(payload.interaction.guild_id.clone())
                                .set_channel(payload.interaction.channel_id.clone())
                                .set_code_path("app/src/scripts/slashs/xp.rs:guild_rank:350"),
                            interaction: BroadcastInteraction::default()
                                .set_name("guild_rank")
                                .set_type(BroadcastInteractionType::SlashCommand),
                            details: BroadcastDetails::default()
                ...
                Err(e) => {
                    ...
                    broadcast_error!(
                        localisation: BroadcastLocalisation::default()
                            .set_guild(payload.interaction.guild_id.clone())
                            .set_channel(payload.interaction.channel_id.clone())
                            .set_code_path("app/src/scripts/slashs/xp.rs:guild_rank:377"),
                        interaction: BroadcastInteraction::default()
                            .set_name("guild_rank")
                            .set_type(BroadcastInteractionType::SlashCommand),
                        details: BroadcastDetails::default()
            ...
            Err(e) => {
                ...
                broadcast_error!(
                    localisation: BroadcastLocalisation::default()
                        .set_guild(payload.interaction.guild_id.clone())
                        .set_channel(payload.interaction.channel_id.clone())
                        .set_code_path("app/src/scripts/slashs/xp.rs:guild_rank:396"),
                    interaction: BroadcastInteraction::default()
                        .set_name("guild_rank")
                        .set_type(BroadcastInteractionType::SlashCommand),
                    details: BroadcastDetails::default()
            ...
            Err(e) => {
                ...
                broadcast_error!(
                    localisation: BroadcastLocalisation::default()
                        .set_guild(payload.interaction.guild_id.clone())
                        .set_channel(payload.interaction.channel_id.clone())
                        .set_code_path("app/src/scripts/slashs/xp.rs:guild_rank:458"),
                    interaction: BroadcastInteraction::default()
                        .set_name("guild_rank")
                        .set_type(BroadcastInteractionType::SlashCommand),
                    details: BroadcastDetails::default()
