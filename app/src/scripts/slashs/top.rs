    ...
    let data = if let Some(d) = &payload.interaction.data {
        ...
        broadcast_error!(
            localisation: BroadcastLocalisation::default()
                ...
                .set_code_path("app/src/scripts/slashs/top.rs:triggered:30"),
    ...
    if data.options.is_none() {
        ...
        broadcast_error!(
            localisation: BroadcastLocalisation::default()
                .set_guild(payload.interaction.guild_id.clone())
                .set_channel(payload.interaction.channel_id.clone())
                .set_code_path("app/src/scripts/slashs/top.rs:triggered:49"),
            interaction: BroadcastInteraction::default()
                .set_name("top")
                .set_type(BroadcastInteractionType::SlashCommand),
            details: BroadcastDetails::default()
                ...
                Err(e) => {
                    ...
                    broadcast_error!(
                        localisation: BroadcastLocalisation::default()
                            .set_guild(payload.interaction.guild_id.clone())
                            .set_channel(payload.interaction.channel_id.clone())
                            .set_code_path("app/src/scripts/slashs/top.rs:categories::xp:74"),
                        interaction: BroadcastInteraction::default()
                            .set_name("top")
                            .set_type(BroadcastInteractionType::SlashCommand),
                        details: BroadcastDetails::default()
            ...
            Err(e) => {
                ...
                broadcast_error!(
                    localisation: BroadcastLocalisation::default()
                        .set_guild(payload.interaction.guild_id.clone())
                        .set_channel(payload.interaction.channel_id.clone())
                        .set_code_path("app/src/scripts/slashs/top.rs:categories::xp:104"),
                    interaction: BroadcastInteraction::default()
                        .set_name("top")
                        .set_type(BroadcastInteractionType::SlashCommand),
                    details: BroadcastDetails::default()
                    ...
                    Err(e) => {
                        ...
                        broadcast_error!(
                            localisation: BroadcastLocalisation::default()
                                .set_guild(payload.interaction.guild_id.clone())
                                .set_channel(payload.interaction.channel_id.clone())
                                .set_code_path("app/src/scripts/slashs/top.rs:categories::xp:246"),
                            interaction: BroadcastInteraction::default()
                                .set_name("top")
                                .set_type(BroadcastInteractionType::SlashCommand),
                            details: BroadcastDetails::default()
                ...
                Err(e) => {
                    ...
                    broadcast_error!(
                        localisation: BroadcastLocalisation::default()
                            .set_guild(payload.interaction.guild_id.clone())
                            .set_channel(payload.interaction.channel_id.clone())
                            .set_code_path("app/src/scripts/slashs/top.rs:categories::cookies_global:335"),
                        interaction: BroadcastInteraction::default()
                            .set_name("top")
                            .set_type(BroadcastInteractionType::SlashCommand),
                        details: BroadcastDetails::default()
                ...
                Err(e) => {
                    ...
                    broadcast_error!(
                        localisation: BroadcastLocalisation::default()
                            .set_guild(payload.interaction.guild_id.clone())
                            .set_channel(payload.interaction.channel_id.clone())
                            .set_code_path("app/src/scripts/slashs/top.rs:categories::cookies_global:361"),
                        interaction: BroadcastInteraction::default()
                            .set_name("top")
                            .set_type(BroadcastInteractionType::SlashCommand),
                        details: BroadcastDetails::default()
                    ...
                    Err(e) => {
                        ...
                        broadcast_error!(
                            localisation: BroadcastLocalisation::default()
                                .set_guild(payload.interaction.guild_id.clone())
                                .set_channel(payload.interaction.channel_id.clone())
                                .set_code_path("app/src/scripts/slashs/top.rs:categories::cookies_global:438"),
                            interaction: BroadcastInteraction::default()
                                .set_name("top")
                                .set_type(BroadcastInteractionType::SlashCommand),
                            details: BroadcastDetails::default()
