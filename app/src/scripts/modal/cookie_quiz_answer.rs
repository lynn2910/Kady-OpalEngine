        ...
        None => {
            ...
            broadcast_error!(
                localisation: BroadcastLocalisation::default()
                    ...
                    .set_code_path("app/src/scripts/modal/cookie_quiz_answer.rs:29"),
        ...
        None => {
            ...
            broadcast_error!(
                localisation: BroadcastLocalisation::default()
                    .set_guild(payload.interaction.guild_id.clone())
                    .set_channel(payload.interaction.channel_id.clone())
                    .set_code_path("app/src/scripts/modal/cookie_quiz_answer.rs:56"),
                interaction: BroadcastInteraction::default()
                    .set_name("cookie_quiz_answer")
                    .set_type(BroadcastInteractionType::Modal),
                details: BroadcastDetails::default()
        ...
        Err(e) => {
            ...
            broadcast_error!(
                localisation: BroadcastLocalisation::default()
                    .set_guild(payload.interaction.guild_id.clone())
                    .set_channel(payload.interaction.channel_id.clone())
                    .set_code_path("app/src/scripts/modal/cookie_quiz_answer.rs:85"),
                interaction: BroadcastInteraction::default()
                    .set_name("cookie_quiz_answer")
                    .set_type(BroadcastInteractionType::Modal),
                details: BroadcastDetails::default()
        ...
        Err(e) => {
            ...
            broadcast_error!(
                localisation: BroadcastLocalisation::default()
                    .set_guild(payload.interaction.guild_id.clone())
                    .set_channel(payload.interaction.channel_id.clone())
                    .set_code_path("app/src/scripts/modal/cookie_quiz_answer.rs:115"),
                interaction: BroadcastInteraction::default()
                    .set_name("cookie_quiz_answer")
                    .set_type(BroadcastInteractionType::Modal),
                details: BroadcastDetails::default()
                    ...
                    None => {
                        ...
                        broadcast_error!(
                            localisation: BroadcastLocalisation::default()
                                .set_guild(payload.interaction.guild_id.clone())
                                .set_channel(payload.interaction.channel_id.clone())
                                .set_code_path("app/src/scripts/modal/cookie_quiz_answer.rs:141"),
                            interaction: BroadcastInteraction::default()
                                .set_name("cookie_quiz_answer")
                                .set_type(BroadcastInteractionType::Modal),
                            details: BroadcastDetails::default()
                    ...
                    _ => {
                        ...
                        broadcast_error!(
                            localisation: BroadcastLocalisation::default()
                                .set_guild(payload.interaction.guild_id.clone())
                                .set_channel(payload.interaction.channel_id.clone())
                                .set_code_path("app/src/scripts/modal/cookie_quiz_answer.rs:160"),
                            interaction: BroadcastInteraction::default()
                                .set_name("cookie_quiz_answer")
                                .set_type(BroadcastInteractionType::Modal),
                            details: BroadcastDetails::default()
                        ...
                        if let Component::TextInput(text_input) = f {
                                ...
                                None => {
                                    ...
                                    broadcast_error!(
                                        localisation: BroadcastLocalisation::default()
                                            .set_guild(payload.interaction.guild_id.clone())
                                            .set_channel(payload.interaction.channel_id.clone())
                                            .set_code_path("app/src/scripts/modal/cookie_quiz_answer.rs:185"),
                                        interaction: BroadcastInteraction::default()
                                            .set_name("cookie_quiz_answer")
                                            .set_type(BroadcastInteractionType::Modal),
                                        details: BroadcastDetails::default()
                            ...
                            broadcast_error!(
                                localisation: BroadcastLocalisation::default()
                                    .set_guild(payload.interaction.guild_id.clone())
                                    .set_channel(payload.interaction.channel_id.clone())
                                    .set_code_path("app/src/scripts/modal/cookie_quiz_answer.rs:230"),
                                interaction: BroadcastInteraction::default()
                                    .set_name("cookie_quiz_answer")
                                    .set_type(BroadcastInteractionType::Modal),
                                details: BroadcastDetails::default()
                    ...
                    None => {
                        ...
                        broadcast_error!(
                            localisation: BroadcastLocalisation::default()
                                .set_guild(payload.interaction.guild_id.clone())
                                .set_channel(payload.interaction.channel_id.clone())
                                .set_code_path("app/src/scripts/modal/cookie_quiz_answer.rs:250"),
                            interaction: BroadcastInteraction::default()
                                .set_name("cookie_quiz_answer")
                                .set_type(BroadcastInteractionType::Modal),
                            details: BroadcastDetails::default()
            ...
            None => {
                ...
                broadcast_error!(
                    localisation: BroadcastLocalisation::default()
                        .set_guild(payload.interaction.guild_id.clone())
                        .set_channel(payload.interaction.channel_id.clone())
                        .set_code_path("app/src/scripts/modal/cookie_quiz_answer.rs:267"),
                    interaction: BroadcastInteraction::default()
                        .set_name("cookie_quiz_answer")
                        .set_type(BroadcastInteractionType::Modal),
                    details: BroadcastDetails::default()
        ...
        None => {
            ...
            broadcast_error!(
                localisation: BroadcastLocalisation::default()
                    .set_guild(payload.interaction.guild_id.clone())
                    .set_channel(payload.interaction.channel_id.clone())
                    .set_code_path("app/src/scripts/modal/cookie_quiz_answer.rs:291"),
                interaction: BroadcastInteraction::default()
                    .set_name("cookie_quiz_answer")
                    .set_type(BroadcastInteractionType::Modal),
                details: BroadcastDetails::default()
        ...
        if let Err(e) = question_completed_result {
            ...
            broadcast_error!(
                localisation: BroadcastLocalisation::default()
                    .set_guild(payload.interaction.guild_id.clone())
                    .set_channel(payload.interaction.channel_id.clone())
                    .set_code_path("app/src/scripts/modal/cookie_quiz_answer.rs:327"),
                interaction: BroadcastInteraction::default()
                    .set_name("cookie_quiz_answer")
                    .set_type(BroadcastInteractionType::Modal),
                details: BroadcastDetails::default()
        ...
        if let Err(e) = cookie_given {
            ...
            broadcast_error!(
                localisation: BroadcastLocalisation::default()
                    .set_guild(payload.interaction.guild_id.clone())
                    .set_channel(payload.interaction.channel_id.clone())
                    .set_code_path("app/src/scripts/modal/cookie_quiz_answer.rs:350"),
                interaction: BroadcastInteraction::default()
                    .set_name("cookie_quiz_answer")
                    .set_type(BroadcastInteractionType::Modal),
                details: BroadcastDetails::default()
        ...
        if let Err(e) = question_completed_result {
            ...
            broadcast_error!(
                localisation: BroadcastLocalisation::default()
                    .set_guild(payload.interaction.guild_id.clone())
                    .set_channel(payload.interaction.channel_id.clone())
                    .set_code_path("app/src/scripts/modal/cookie_quiz_answer.rs:386"),
                interaction: BroadcastInteraction::default()
                    .set_name("cookie_quiz_answer")
                    .set_type(BroadcastInteractionType::Modal),
                details: BroadcastDetails::default()
        ...
        if let Err(e) = nuggets_given {
            ...
            broadcast_error!(
                localisation: BroadcastLocalisation::default()
                    .set_guild(payload.interaction.guild_id.clone())
                    .set_channel(payload.interaction.channel_id.clone())
                    .set_code_path("app/src/scripts/modal/cookie_quiz_answer.rs:414"),
                interaction: BroadcastInteraction::default()
                    .set_name("cookie_quiz_answer")
                    .set_type(BroadcastInteractionType::Modal),
                details: BroadcastDetails::default()
